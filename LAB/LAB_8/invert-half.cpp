...
Task B: write a program that inverts all colors only in the right half the image. So white shades become black, and black become white
*/
...
int main() {
	...
	//variables to sore height and width
	int h, w;
	...
	for(int row = 0; row < h; row++){
        //if left to right gets left side inverted then lets start at the right (max value width) and go left until we get to half the image width. 
        //So we get right side inverted colors
